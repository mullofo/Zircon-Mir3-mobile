...
namespace Client.Scenes.Configs
{
    ...
    public static class BigPatchConfig
    {
        ...
        /// 自动神圣战甲术
        /// </summary>
        public static bool AutoResilience { get; set; } = false;
        /// <summary>
        /// 自动强魔震法
        /// </summary>
        public static bool AutoElementalSuperiority { get; set; } = false;
        /// <summary>
        /// 自动猛虎强势
        /// </summary>
        public static bool AutoBloodLust { get; set; } = false;
        /// <summary>
        /// 自动幽灵盾
        /// </summary>
        public static bool AutoResistance { get; set; } = false;
        /// <summary>
        /// 自动移花接玉
        /// </summary>
        public static bool AutoStrengthOfFaith { get; set; } = false;
        /// <summary>
        /// 自动阴阳盾
        /// </summary>
        ...
        /// 来消息声音提醒
        /// </summary>
        public static bool ChkMsgNotify { get; set; } = false;
