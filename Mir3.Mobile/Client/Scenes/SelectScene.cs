    ...
    public sealed class SelectScene : DXScene
    {
        ...
        public sealed class SelectDialog : DXImageControl
        {
            ...
            public SelectDialog()
            {
                ...
                NameLabel = new DXLabel
                {
                    ...
                    Text = "名字".Lang(),
                    Font = new Font(Config.FontName, CEnvir.FontSize(9F), FontStyle.Bold),
                    Location = new Point(label.Location.X + label.Size.Width + 10, label.Location.Y),
                    IsControl = false,
                };
                ...
                label = new DXLabel
                {
                    ...
                    Location = new Point(10, label.Location.Y + label.Size.Height + 5),
                    IsControl = false,
                };
            ...
            public void UpdateCharacterPanel()
            {
                ...
                CharacterPanel.Size = new Size(Math.Max(CharacterPanel.Size.Width, NameLabel.Location.X + NameLabel.Size.Width + 10), Math.Max(CharacterPanel.Size.Height, NameLabel.Size.Height + LevelLabel.Size.Height + JobLabel.Size.Height + 20 + 10));
            ...
            private void Animation_AfterDraw(DXAnimatedControl ChrAnimation)
            {
                ...
                if (image != null)
                    PresentMirImage(image.Image, ChrAnimation.Parent, new Rectangle(x + image.OffSetX, y + image.OffSetY, image.Width, image.Height), Color.White, this, zoomRate: ZoomRate, uiOffsetX: UI_Offset_X);
            ...
            private void Animation_BeforeDraw(DXAnimatedControl ChrAnimation)
            {
                ...
                if (image?.Image != null)
                    PresentMirImage(image.Image, ChrAnimation.Parent, new Rectangle(x + image.OffSetX, y + image.OffSetY, image.Width, image.Height), Color.FromArgb(180, 255, 255, 255), this, zoomRate: ZoomRate, uiOffsetX: UI_Offset_X);
        ...
        public sealed class NewCharacterDialog : DXImageControl
        {
            ...
            public NewCharacterDialog()
            {
                ...
                {
                    Location = new Point(287 - 247, 400 - 384),
                    Parent = Career,
                ...
                CreateNewCharacterButton = new DXButton  //创建按钮
                {
                    ...
                    Index = 85,
                    Parent = this,
                    Location = new Point(Mir3.Mobile.Game1.Native.UI.IsAllScreen ? Size.Width - 100 : 450, 435)
                };
                ...
                CloseNewCharacterButton = new DXButton  //关闭按钮
                {
                    ...
                    Index = 88,
                    Parent = this,
                    Location = new Point(CreateNewCharacterButton.Location.X + 41, CreateNewCharacterButton.Location.Y),
                };
            ...
            private void CharacterCreate_BeforeDraw(object sender, EventArgs e)
            {
                ...
                if (image?.Image != null)
                    PresentMirImage(image.Image, animation.Parent, new Rectangle(x + image.OffSetX, y + image.OffSetY, image.Width, image.Height), Color.FromArgb(180, 255, 255, 255), this, zoomRate: ZoomRate, uiOffsetX: UI_Offset_X);
