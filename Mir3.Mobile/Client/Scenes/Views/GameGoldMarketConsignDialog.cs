...
namespace Client.Scenes.Views
{
    ...
    /// 元宝寄售
    /// </summary>
    public sealed class GameGoldMarketConsignDialog : DXWindow
    {
        #region Properites
        ...
        /// 元宝寄售上架
        /// </summary>
        public GameGoldMarketConsignDialog()
        {
            HasTitle = false;
            HasFooter = false;
            HasTopBorder = false;
            ...
            ConsignPriceLabelBox.ListBox.SelectItem(CurrencyType.GameGold);
        ...
        private void ConsignButton_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            message.Append($"寄售费用".Lang() + $": {(Cost / 100):###0}");
            ...
            new DXConfirmWindow(message.ToString(), DXMessageBoxButtons.YesNo, () =>
            {
                CEnvir.Enqueue(new C.MarketPlaceConsign
                {
                    ...
                    PriceType = CurrencyType.GameGold,
