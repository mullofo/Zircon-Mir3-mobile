...
namespace Client.Scenes.Views
{
    ...
    public sealed class BigMapDialog : DXWindow
    {
        ...
        {
            if (!File.Exists(CEnvir.MobileClientPath + Config.MapPath + fileName + ".map")) return Size.Empty;

            using (FileStream stream = File.OpenRead(CEnvir.MobileClientPath + Config.MapPath + fileName + ".map"))
        ...
        public BigMapDialog()
        {
            ...
            Image.TouchHold += Image_OnCheckHold;
        }
        ...
        private void Image_OnCheckHold(object sender, TouchEventArgs e)
        {
            if (BigPatchConfig.AndroidPlayer) return;
        ...
        /// 更新自动寻路线条
        /// </summary>
        private void UpdatePathForDraw()
        {
