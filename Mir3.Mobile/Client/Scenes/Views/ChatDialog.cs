...
namespace Client.Scenes.Views
{
    ...
    public class ChatDialog : DXWindow
    {
        ...
        public ChatDialog()
        {
            ...
            //Photo.MouseClick += (o, e) =>
            //{
            //    Photo.MiniMap = !Photo.MiniMap;
            //};
            ...
            Upgrade.AfterDraw += delegate
            {
                ...
                if (mirImage2 == null) return;
                PresentMirImage(mirImage2.Image, this, new Rectangle(Upgrade.DisplayArea.X, Upgrade.DisplayArea.Y, mirImage2.Width, mirImage2.Height), Color.White, Upgrade, zoomRate: ZoomRate, uiOffsetX: UI_Offset_X);
            };
