...
namespace Client.Scenes.Views
{
    ...
    public sealed class NPCDialog : DXWindow
    {
        ...
        public NPCDialog()
        {
            ...
            {
                Size = new Size(TopPanel.Size.Width, 70),
                Parent = this,
                LibraryFile = LibraryFile.UI1,
                Index = 1351,
                FixedSize = true,
            ...
            PageText = new DXLabel  //页面文本
            {
                ...
                PassThrough = true,
#if Mobile
                //Font = new Font(Config.FontName, CEnvir.FontSize(11F)),
#endif
            };
        ...
        public void NewText(List<string> lines, bool resetIndex = true)
        {
            ...
            for (int i = _index; i < lastLine; i++)
            {
                ...
                foreach (Match match in matchList.OrderBy(o => o.Index).ToList())
                {
                    ...
                    {
                        NewButton(btnIndex, txt, action, new Point(TextLabels[i].Location.X + size.Width - 12, TextLabels[i].Location.Y));
                        btnIndex++;
                    }

                    if (C.Match(match.Value).Success)
                    {
                        NewColour(colorIndex, txt, action, new Point(TextLabels[i].Location.X + size.Width - 12, TextLabels[i].Location.Y));
                        colorIndex++;
                    }
        ...
        public void SetShowBg(NPCCustomBG bg)
        {
            if (null != bg && (bg.url != "" || (bg.file != -1 && bg.idx != -1)))
            {
                ...
                if (bg.center == 0)
                {
                    Location = new Point(ActiveScene.NativeUI.ScreenOffset.X + bg.offset_x, 0 + bg.offset_y);
                }
                else
                {
                    Location = new Point(CEnvir.Target.Width / 2 - CustomPanel.Size.Width / 2 + bg.offset_x,
                        CEnvir.Target.Height / 2 - CustomPanel.Size.Height / 2 + bg.offset_y);
                }
            ...
            {
                Location = new Point(ActiveScene.NativeUI.ScreenOffset.X, 0);
                //显示默认的背景内容
        ...
        public void Response(S.NPCResponse info)
        {
            ...
            switch (dialogType)  //页面显示的位置坐标
            {
                ...
                case NPCDialogType.BuySell:   //买
                    GameScene.Game.NPCGoodsBox.Location = new Point(Location.X, Size.Height); //不遮挡NPC对话框
                ...
                case NPCDialogType.Sell:      //卖
                    ...
                    GameScene.Game.NPCSellBox.Location = new Point(Location.X, Size.Height);
                    //GameScene.Game.InventoryBox.Location = new Point(Location.X + Size.Width, Location.Y);
                    if (GameScene.Game.Observer)   //如果是观察者
                        GameScene.Game.InventoryBox.Visible = false;
                    GameScene.Game.NPCQuestListBox.Visible = false;
                ...
                case NPCDialogType.SpecialRepair:      //特殊修理
                    ...
                    GameScene.Game.NPCSpecialRepairBox.Location = new Point(Location.X, 0);
                    //GameScene.Game.InventoryBox.Location = new Point(Location.X + Size.Width, Location.Y);
                    if (GameScene.Game.Observer)   //如果是观察者
                        GameScene.Game.InventoryBox.Visible = false;
                    GameScene.Game.NPCQuestListBox.Visible = false;
                ...
                case NPCDialogType.RootSell:   //一键出售
                    ...
                    GameScene.Game.NPCRootSellBox.Location = new Point(Location.X, Size.Height);
                    //GameScene.Game.InventoryBox.Location = new Point(Location.X + Size.Width, Location.Y);
                    if (GameScene.Game.Observer)   //如果是观察者
                        GameScene.Game.InventoryBox.Visible = false;
                    GameScene.Game.NPCQuestListBox.Visible = false;
                ...
                case NPCDialogType.RefinementStone:   //精炼石
                    ...
                    GameScene.Game.NPCRefinementStoneBox.Location = new Point(Location.X, 0);
                    GameScene.Game.NPCQuestListBox.Visible = false;
                    break;
                case NPCDialogType.Refine:   //精炼
                    GameScene.Game.NPCRefineBox.Visible = true;
                    GameScene.Game.NPCRefineBox.Location = new Point(Location.X, 0);
                    GameScene.Game.NPCQuestListBox.Visible = false;
                    break;
                case NPCDialogType.MasterRefine:  //大师精炼
                    GameScene.Game.NPCMasterRefineBox.Visible = true;
                    GameScene.Game.NPCMasterRefineBox.Location = new Point(Location.X, 0);
                    GameScene.Game.NPCQuestListBox.Visible = false;
                    break;
                case NPCDialogType.RefineRetrieve:  //高级精炼
                    GameScene.Game.NPCRefineRetrieveBox.Location = new Point(Location.X, 0);
                ...
                case NPCDialogType.CompanionManage:  //宠物管理
                    ...
                    GameScene.Game.NPCCompanionStorageBox.Location = new Point(Location.X, 0);
                ...
                case NPCDialogType.Additional:        //额外属性
                    GameScene.Game.AdditionalBox.Location = new Point(Location.X, 0);
                ...
                case NPCDialogType.BookCombine:        //技能书合成
                    ...
                    GameScene.Game.NPCBookCombineBox.Location = new Point(Location.X, 0);
                    GameScene.Game.NPCQuestListBox.Visible = false;
                    break;
        ...
        public void ShowBackGoods(S.NPCBuyBack p)
        {
            ...
            if (goods?.Count > 0)
            {
                ...
                GameScene.Game.NPCBuyBackBox.Location = new Point(Location.X, Size.Height);
                GameScene.Game.NPCQuestListBox.Visible = false;
            }
        ...
        {
            //Size DefSize = DXLabel.GetSize("字", PageText.Font, PageText.Outline, new Size(4096, 4096));
...
#if Mobile
                while (offset + size.Width > PageText.Size.Width + 15)
#else
                ...
                for (int i = 0; i < result.Count; i++)
                {
                    ...
                    else if (1 == richInfo.type) //处理[text]
                    {
                        ...
                        e_text.MouseEnter += (o, e) =>     //鼠标移动上去
                        {
                            ...
                            e_text.Font = new Font(e_text.Font.FontName, e_text.Font.Size, FontStyle.Underline); //增加文字下划线
                        };
                        e_text.MouseLeave += (o, e) =>   //鼠标离开
                        {
                            if (GameScene.Game.Observer) return;
                            e_text.ForeColour = Color.Yellow;
                            e_text.Font = new Font(e_text.Font.FontName, e_text.Font.Size, FontStyle.Regular); //去掉文字下划线
                        };
...
#if Mobile
                                        var sSize = DXLabel.GetSize(text, new Font(PageText.Font.FontName, 11F), PageText.Outline, new Size(4096, 4096), TextFormatFlags.SingleLine);
#else
    ...
    public class NPCGoodsDialog : DXWindow
    {
        ...
        public NPCGoodsDialog()
        {
            ...
            {
                Parent = ClientPanel,
                Size = new Size(352, 185),//ClientArea.Size,
                Location = new Point(15, 22),//ClientArea.Location,
                PassThrough = true,
            };
            GoodsPanel.FreeDrag += DoMouseWheel;

            ScrollBar = new DXVScrollBar   //购物滚动条
            {
                Parent = ClientPanel,
                Size = new Size(24, ClientPanel.Size.Height - 60),
                Change = 62,
                VisibleSize = 3 * 62,
                Visible = false,
            };
            ...
            ClientPanel.FreeDrag += DoMouseWheel;
            ...
            BuyButton.Location = new Point((Size.Width - BuyButton.Size.Width) / 2, Size.Height - BuyButton.Size.Height - 20);
            ...
            GuildCheckBox.Location = new Point(BuyButton.Location.X - GuildCheckBox.Size.Width - 20, BuyButton.Location.Y + (BuyButton.Size.Height - GuildCheckBox.Size.Height) / 2 + 2);
        ...
        public virtual void NewGoods(IList<ClientNPCGood> goods)
        {
            ...
            foreach (ClientNPCGood good in goods)
            {
                ...
                cell.ItemCell.FreeDrag += DoMouseWheel;
                cell.ItemDetial.FreeDrag += DoMouseWheel;
            ...
            if (goods.Count < 6)
            {
                ScrollBar.MaxValue = 3 * ScrollBar.Change;
            }
            else
            {
                ScrollBar.MaxValue = goods.Count / 2 * ScrollBar.Change;
                if (goods.Count % 2 > 0)
                    ScrollBar.MaxValue += ScrollBar.Change;
            }
        ...
        protected virtual void UpdateLocations()
        {
            ...
            for (int i = 0; i < Cells.Count; i++)
            {
                ...
                x += cell.Size.Width + 15;

                if ((i + 1) % 2 == 0)
                {
                    x = 10;
                    y += cell.Size.Height + 10;
                }
            }
        }
        /// <summary>
        ...
        /// <param name="e"></param>
        public void DoMouseWheel(object sender, TouchEventArgs e)
        {
            int value = (int)e.Delta.Y;
            ScrollBar.Value -= value / 10 * ScrollBar.Change;
        }
    ...
    public sealed class NPCGoodsCell : DXControl
    {
        ...
        public void OnGoodChanged(ClientNPCGood oValue, ClientNPCGood nValue)
        {
            ...
            RequirementLabel.Location = new Point(ItemNameLabel.Location.X, ItemNameLabel.Location.Y + ItemNameLabel.Size.Height - 2);
            ...
            if (GoldIcon.Visible)
            {
                CostLabel.Location = new Point(GoldIcon.Location.X - CostLabel.Size.Width, GoldIcon.Location.Y - ((CostLabel.Size.Height - GoldIcon.Size.Height) / 2));
            }
            else
            {
        ...
        public NPCGoodsCell(int imageNum = 121)
        {
            ...
            Size = new Size(155, 52);

            ItemCell = new DXItemCell   //道具单元
            {
                Parent = this,
                Location = new Point((Size.Height - DXItemCell.CellWidth) / 2, (Size.Height - DXItemCell.CellHeight) / 2), //(Size.Height - DXItemCell.CellHeight) / 2),
                FixedBorder = false,
                ReadOnly = true,
            ...
            {
                Parent = this,
                Size = new Size(Size.Width - (ItemCell.Location.X * 2 + ItemCell.Size.Width), 50),
                Border = false,
            };
            ItemDetial.Location = new Point(Size.Width - ItemDetial.Size.Width, (Size.Height - ItemDetial.Size.Height) / 2);
            ...
            GoldIcon.Location = new Point(ItemDetial.Size.Width - GoldIcon.Size.Width, ItemDetial.Size.Height - GoldIcon.Size.Height);
    ...
    public sealed class NPCSellDialog : DXWindow
    {
        ...
        public NPCSellDialog()
        {
            ...
            selectAll.Location = new Point(25, Size.Height - selectAll.Size.Height - 25);
            ...
            label.Location = new Point(selectAll.Location.X + selectAll.Size.Width + 25, selectAll.Location.Y + (selectAll.Size.Height - label.Size.Height) / 2);
            ...
            SellButton.Location = new Point(Size.Width - SellButton.Size.Width - 50, Size.Height - SellButton.Size.Height - 25);
            ...
            Close1Button.Location = new Point(346, 215);
            Close1Button.MouseClick += (o, e) => Visible = false;
        }
                ...
                foreach (DKeyPage option in menu.Options)
                {
                    ...
                    if (option.targetNPCIndex > 0)
                    {
                        ...
                        label.MouseEnter += (o, e) =>     //鼠标移动上去
                        {
                            ...
                            label.Font = new Font(label.Font.FontName, label.Font.Size, FontStyle.Underline); //增加文字下划线
                        };
                        ...
                        label.MouseLeave += (o, e) =>   //鼠标离开
                        {
                            ...
                            label.Font = new Font(label.Font.FontName, label.Font.Size, FontStyle.Regular); //去掉文字下划线
                        };
    ...
    public sealed class NPCBuyBackDialog : NPCGoodsDialog
    {
        ...
        private int TotalPageIndex { get; set; } = 1;
        ...
        public NPCBuyBackDialog() : base()
        {
            ...
            RightPanel = new DXImageControl
            {
                ...
                Location = new Point(ClientPanel.Location.X + ClientPanel.Size.Width, ClientPanel.Location.Y),
                Parent = this,
                Visible = false,
            };
            ...
            Close2Button.Location = new Point(RightPanel.Size.Width - 40, RightPanel.Size.Height - 47);
        ...
        public void NewGoods(IList<ClientNPCGood> goods, int pageIndex, int total)
        {
            ...
            {
                ScrollBar.MaxValue = Cells.Count / 2 * ScrollBar.Change;
                if (Cells.Count % 2 > 0)
                    ScrollBar.MaxValue += ScrollBar.Change;
            }

            PageIndex = pageIndex;
            TotalPageIndex = total;

            if (pageIndex == 1) ScrollBar.Value = 0;
            UpdateLocations();
        }
        ...
        //    BuyButton.Location = new Point(BuyButton.Location.X, BuyButton.Location.Y + 4);
        //}
        ...
        protected override void UpdateLocations()
        {
            ...
            //托到底执行翻页
            if (ScrollBar.MaxValue - ScrollBar.Value <= ScrollBar.VisibleSize)
            {
                if (PageIndex >= TotalPageIndex) return;
                PageIndex++;
        ...
        private void GoBuy()
        {
            ...
            Size = new Size(ClientPanel.Size.Width + RightPanel.Size.Width, Size.Height);
        }
