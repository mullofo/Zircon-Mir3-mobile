...
namespace Client.Scenes.Views
{
    ...
    public sealed class CharacterDialog : DXWindow
    {
        ...
        public DXButton MakeButton, OpenMakeDialogButton;
        ...
        public CharacterDialog()
        {
            ...
            OpenMakeDialogButton = new DXButton //打开制作列表按钮
            {
                Index = 6247,
                LibraryFile = LibraryFile.GameInter,
            ...
            OpenMakeDialogButton.MouseClick += (sender, args) => { GameScene.Game.CraftBox.Visible = true; };
            ...
            AttackStats[Stat.FireAttack] = new DXLabel
            {
                ...
                Parent = CharacterTabBackGround,
                Location = new Point(Fireicon.Location.X + Fireicon.Size.Width, 379),
            ...
            AttackStats[Stat.IceAttack] = new DXLabel
            {
                ...
                Font = new Font(Config.FontName, CEnvir.FontSize(8F)),
                Parent = CharacterTabBackGround,
                Location = new Point(Iceicon.Location.X + Iceicon.Size.Width, 379),
                ForeColour = Color.FromArgb(60, 60, 60),
                Text = "0",
                Tag = Iceicon,
            };
            ...
            AttackStats[Stat.LightningAttack] = new DXLabel
            {
                ...
                Font = new Font(Config.FontName, CEnvir.FontSize(8F)),
                Parent = CharacterTabBackGround,
                Location = new Point(Lightningicon.Location.X + Lightningicon.Size.Width, 379),
                ForeColour = Color.FromArgb(60, 60, 60),
                Text = "0",
                Tag = Lightningicon,
            };
            ...
            AttackStats[Stat.WindAttack] = new DXLabel
            {
                ...
                Font = new Font(Config.FontName, CEnvir.FontSize(8F)),
                Parent = CharacterTabBackGround,
                Location = new Point(Windicon.Location.X + Windicon.Size.Width, 379),
                ForeColour = Color.FromArgb(60, 60, 60),
                Text = "0",
                Tag = Windicon,
            };
            ...
            AttackStats[Stat.HolyAttack] = new DXLabel
            {
                ...
                Font = new Font(Config.FontName, CEnvir.FontSize(8F)),
                Parent = CharacterTabBackGround,
                Location = new Point(Holyicon.Location.X + Holyicon.Size.Width, 379),
                ForeColour = Color.FromArgb(60, 60, 60),
                Text = "0",
                Tag = Holyicon,
            };
            ...
            AttackStats[Stat.DarkAttack] = new DXLabel
            {
                ...
                Font = new Font(Config.FontName, CEnvir.FontSize(8F)),
                Parent = CharacterTabBackGround,
                Location = new Point(Darkicon.Location.X + Darkicon.Size.Width, 379),
                ForeColour = Color.FromArgb(60, 60, 60),
                Text = "0",
                Tag = Darkicon,
            };
            ...
            AttackStats[Stat.PhantomAttack] = new DXLabel
            {
                ...
                Font = new Font(Config.FontName, CEnvir.FontSize(8F)),
                Parent = CharacterTabBackGround,
                Location = new Point(Phantomicon.Location.X + Phantomicon.Size.Width, 379),
                ForeColour = Color.FromArgb(60, 60, 60),
                Text = "0",
                Tag = Phantomicon,
            };
            ...
            AdvantageStats[Stat.FireResistance] = new DXLabel
            {
                ...
                Font = new Font(Config.FontName, CEnvir.FontSize(8F)),
                Parent = CharacterTabBackGround,
                Location = new Point(StrongFireicon.Location.X + StrongFireicon.Size.Width, 409),
                ForeColour = Color.FromArgb(60, 60, 60),
                Text = "0",
                Tag = StrongFireicon,
            };
            ...
            AdvantageStats[Stat.IceResistance] = new DXLabel
            {
                ...
                Font = new Font(Config.FontName, CEnvir.FontSize(8F)),
                Parent = CharacterTabBackGround,
                Location = new Point(StrongIceicon.Location.X + StrongIceicon.Size.Width, 409),
                ForeColour = Color.FromArgb(60, 60, 60),
                Text = "0",
                Tag = StrongIceicon,
            };
            ...
            AdvantageStats[Stat.LightningResistance] = new DXLabel
            {
                ...
                Font = new Font(Config.FontName, CEnvir.FontSize(8F)),
                Parent = CharacterTabBackGround,
                Location = new Point(StrongLightningicon.Location.X + StrongLightningicon.Size.Width, 409),
                ForeColour = Color.FromArgb(60, 60, 60),
                Text = "0",
            ...
            AdvantageStats[Stat.WindResistance] = new DXLabel
            {
                ...
                Font = new Font(Config.FontName, CEnvir.FontSize(8F)),
                Parent = CharacterTabBackGround,
                Location = new Point(StrongWindicon.Location.X + StrongWindicon.Size.Width, 409),
                ForeColour = Color.FromArgb(60, 60, 60),
                Text = "0",
                Tag = StrongWindicon,
            };
            ...
            AdvantageStats[Stat.HolyResistance] = new DXLabel
            {
                ...
                Font = new Font(Config.FontName, CEnvir.FontSize(8F)),
                Parent = CharacterTabBackGround,
                Location = new Point(StrongHolyicon.Location.X + StrongHolyicon.Size.Width, 409),
                ForeColour = Color.FromArgb(60, 60, 60),
                Text = "0",
                Tag = StrongHolyicon,
            };
            ...
            AdvantageStats[Stat.DarkResistance] = new DXLabel
            {
                ...
                Font = new Font(Config.FontName, CEnvir.FontSize(8F)),
                Parent = CharacterTabBackGround,
                Location = new Point(StrongDarkicon.Location.X + StrongDarkicon.Size.Width, 409),
                ForeColour = Color.FromArgb(60, 60, 60),
                Text = "0",
                Tag = StrongDarkicon,
            };
            ...
            AdvantageStats[Stat.PhantomResistance] = new DXLabel
            {
                ...
                Font = new Font(Config.FontName, CEnvir.FontSize(8F)),
                Parent = CharacterTabBackGround,
                Location = new Point(StrongPhantomicon.Location.X + StrongPhantomicon.Size.Width, 409),
                ForeColour = Color.FromArgb(60, 60, 60),
                Text = "0",
            ...
            DisadvantageStats[Stat.FireResistance] = new DXLabel
            {
                ...
                Font = new Font(Config.FontName, CEnvir.FontSize(8F)),
                Parent = CharacterTabBackGround,
                Location = new Point(WeakFireicon.Location.X + WeakFireicon.Size.Width, 439),
                ForeColour = Color.FromArgb(60, 60, 60),
                Text = "0",
                Tag = WeakFireicon,
            };
            ...
            DisadvantageStats[Stat.IceResistance] = new DXLabel
            {
                ...
                Font = new Font(Config.FontName, CEnvir.FontSize(8F)),
                Parent = CharacterTabBackGround,
                Location = new Point(WeakIceicon.Location.X + WeakIceicon.Size.Width, 439),
                ForeColour = Color.FromArgb(60, 60, 60),
                Text = "0",
                Tag = WeakIceicon,
            };
            ...
            DisadvantageStats[Stat.LightningResistance] = new DXLabel
            {
                ...
                Font = new Font(Config.FontName, CEnvir.FontSize(8F)),
                Parent = CharacterTabBackGround,
                Location = new Point(WeakLightningicon.Location.X + WeakLightningicon.Size.Width, 439),
                ForeColour = Color.FromArgb(60, 60, 60),
                Text = "0",
            ...
            DisadvantageStats[Stat.WindResistance] = new DXLabel
            {
                ...
                Font = new Font(Config.FontName, CEnvir.FontSize(8F)),
                Parent = CharacterTabBackGround,
                Location = new Point(WeakWindicon.Location.X + WeakWindicon.Size.Width, 439),
                ForeColour = Color.FromArgb(60, 60, 60),
                Text = "0",
                Tag = WeakWindicon,
            };
            ...
            DisadvantageStats[Stat.HolyResistance] = new DXLabel
            {
                ...
                Font = new Font(Config.FontName, CEnvir.FontSize(8F)),
                Parent = CharacterTabBackGround,
                Location = new Point(WeakHolyicon.Location.X + WeakHolyicon.Size.Width, 439),
                ForeColour = Color.FromArgb(60, 60, 60),
                Text = "0",
                Tag = WeakHolyicon,
            };
            ...
            DisadvantageStats[Stat.DarkResistance] = new DXLabel
            {
                ...
                Font = new Font(Config.FontName, CEnvir.FontSize(8F)),
                Parent = CharacterTabBackGround,
                Location = new Point(WeakDarkicon.Location.X + WeakDarkicon.Size.Width, 439),
                ForeColour = Color.FromArgb(60, 60, 60),
                Text = "0",
                Tag = WeakDarkicon,
            };
            ...
            DisadvantageStats[Stat.PhantomResistance] = new DXLabel
            {
                ...
                Font = new Font(Config.FontName, CEnvir.FontSize(8F)),
                Parent = CharacterTabBackGround,
                Location = new Point(WeakPhantomicon.Location.X + WeakPhantomicon.Size.Width, 439),
                ForeColour = Color.FromArgb(60, 60, 60),
                Text = "0",
                Tag = WeakPhantomicon,
            };
        ...
        public void Draw(DXItemCell cell, int index, LibraryFile libfile, float blendrate)
        {
            ...
            library.Draw(index, x, y, Color.White, false, blendrate, ImageType.Image, zoomRate: ZoomRate);
        }
        ...
        private void Character_AfterDraw(object sender, EventArgs e)
        {
            ...
            if (drawArmour)
            {
                ...
                if (CEnvir.LibraryList.TryGetValue(LibraryFile.EquipEffect_UI, out effectLibrary))
                {
                    ...
                    if (image != null)
                    {
                        PresentMirImage(image.Image, CharacterTabBackGround, new Rectangle(DisplayArea.X + x + image.OffSetX, DisplayArea.Y + y + image.OffSetY, image.Width, image.Height), ForeColour, this, 0, 0, true, 0.8f, zoomRate: ZoomRate, uiOffsetX: UI_Offset_X);
                    }
                }
                #endregion
            }
            ...
            if (CEnvir.LibraryList.TryGetValue(LibraryFile.ProgUse, out library))
            {
                ...
                if (drawHair)
                    if (MapObject.User.Class == MirClass.Assassin && MapObject.User.Gender == MirGender.Female && MapObject.User.HairType == 1)
                        library.Draw(1160, DisplayArea.X + x - 1, DisplayArea.Y + y - 1, MapObject.User.HairColour, true, 1F, ImageType.Image, zoomRate: ZoomRate, uiOffsetX: UI_Offset_X);
                    ...
                    if (MapObject.User.HairType > 0)    //发型 单独处理 不能用自定义特效功能
                    {
                        switch (MapObject.User.Class)
                        {
                            ...
                            case MirClass.Taoist:
                                ...
                                {
                                    case MirGender.Male:
                                        library.Draw(60 + MapObject.User.HairType - 1, DisplayArea.X + x - 1, DisplayArea.Y + y - 1, Color.White, true, 1F, ImageType.Image, zoomRate: ZoomRate, uiOffsetX: UI_Offset_X);
                                        library.Draw(60 + MapObject.User.HairType - 1, DisplayArea.X + x - 1, DisplayArea.Y + y - 1, MapObject.User.HairColour, true, 1F, ImageType.Overlay, zoomRate: ZoomRate, uiOffsetX: UI_Offset_X);
                                        break;
                                    case MirGender.Female:
                                        library.Draw(80 + MapObject.User.HairType - 1, DisplayArea.X + x - 1, DisplayArea.Y + y - 1, Color.White, true, 1F, ImageType.Image, zoomRate: ZoomRate, uiOffsetX: UI_Offset_X);
                                        library.Draw(80 + MapObject.User.HairType - 1, DisplayArea.X + x - 1, DisplayArea.Y + y - 1, MapObject.User.HairColour, true, 1F, ImageType.Overlay, zoomRate: ZoomRate, uiOffsetX: UI_Offset_X);
                                        break;
                                }
                                break;
                            case MirClass.Assassin:
                                ...
                                {
                                    case MirGender.Male:
                                        library.Draw(1100 + MapObject.User.HairType - 1, DisplayArea.X + x - 1, DisplayArea.Y + y - 1, Color.White, true, 1F, ImageType.Image, zoomRate: ZoomRate, uiOffsetX: UI_Offset_X);
                                        library.Draw(1100 + MapObject.User.HairType - 1, DisplayArea.X + x - 1, DisplayArea.Y + y - 1, MapObject.User.HairColour, true, 1F, ImageType.Overlay, zoomRate: ZoomRate, uiOffsetX: UI_Offset_X);
                                        break;
                                    case MirGender.Female:
                                        library.Draw(1120 + MapObject.User.HairType - 1, DisplayArea.X + x - 1, DisplayArea.Y + y - 1, Color.White, true, 1F, ImageType.Image, zoomRate: ZoomRate, uiOffsetX: UI_Offset_X);
                                        library.Draw(1120 + MapObject.User.HairType - 1, DisplayArea.X + x - 1, DisplayArea.Y + y - 1, MapObject.User.HairColour, true, 1F, ImageType.Overlay, zoomRate: ZoomRate, uiOffsetX: UI_Offset_X);
                                        break;
                                }
                                break;
                        }
            ...
            if (CEnvir.LibraryList.TryGetValue(LibraryFile.Equip, out library))
            {
                ...
                if (drawHelmet)
                {
                    ...
                    library.Draw(index, DisplayArea.X + x, DisplayArea.Y + y, Color.White, true, 1F, ImageType.Image, zoomRate: ZoomRate, uiOffsetX: UI_Offset_X);
                    //library.Draw(index, DisplayArea.X + x, DisplayArea.Y + y, helmet.Item.Colour, true, 1F, ImageType.Overlay, uiOffsetX: UI_Offset_X);
                }
                #endregion
        ...
        protected override void Dispose(bool disposing)
        {
            ...
            if (disposing)
            {
                ...
                if (OpenMakeDialogButton != null)
                {
                    if (!OpenMakeDialogButton.IsDisposed)
                        OpenMakeDialogButton.Dispose();

                    OpenMakeDialogButton = null;
                }
