...
namespace Client.Scenes.Views
{
    ...
    public sealed class RankingDialog : DXWindow
    {
        ...
        public RankingDialog()
        {
            ...
            Lines = new RankingLine[10];
            //ScrollBar = new DXVScrollBar       //滚动条
            //{
            //    Parent = this,
            //    Size = new Size(25, 490),
            //    Location = new Point(Size.Width - 10, 30),
            ...
            ObserverButton.Location = new Point(Size.Width - ObserverButton.Size.Width - 105, 85);
            ...
            label.Location = new Point(25, 85);
            ...
            OnlineOnlyBox.Location = new Point(RequiredClassBox.Location.X + RequiredClassBox.Size.Width + 80, RequiredClassBox.Location.Y);
            ...
            Panel = new DXControl
            {
                Location = new Point(25, OnlineOnlyBox.Location.Y + OnlineOnlyBox.Size.Height + 10),
                Size = new Size(460, 235),
                Parent = this,
            };
            Panel.FreeDrag += DoMouseWheel;
            ...
            for (int i = 0; i < Lines.Length; i++)
            {
                ...
                Lines[i].Location = new Point(0, Lines[i].Size.Height * (i + 1) + 1);
                Lines[i].FreeDrag += DoMouseWheel;
            }
