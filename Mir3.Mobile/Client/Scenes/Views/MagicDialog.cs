...
namespace Client.Scenes.Views
{
    ...
    public sealed class MagicDialog : DXWindow
    {
        ...
        public SortedDictionary<MagicSchool, MagicTab> SchoolTabs = new SortedDictionary<MagicSchool, MagicTab>();   //整理排序 按数据库魔法技能树

        public Dictionary<MagicInfo, MagicCell> Magics = new Dictionary<MagicInfo, MagicCell>(); //排序 按魔法信息
        ...
        public MagicCell SelectedMagic
        {
            get => _SelectedMagic;
            set
            {
                if (_SelectedMagic == value) return;

                MagicCell selectedMagic = _SelectedMagic;
                _SelectedMagic = value;

                OnSelectedMagicChanged(selectedMagic, value);
            }
        }
        private MagicCell _SelectedMagic;
        public event EventHandler<EventArgs> SelectedMagicChanged;
        public void OnSelectedMagicChanged(MagicCell oValue, MagicCell nValue)
        {
            if (oValue != null)
            {
                oValue.Image.Border = false;
            }
            if (nValue != null)
            {
                nValue.Image.Border = true;
            }
            EventHandler<EventArgs> selectedMagicChanged = SelectedMagicChanged;
            selectedMagicChanged?.Invoke(this, EventArgs.Empty);
        }
        ...
        public MagicDialog()
        {
            ...
            FireButton.TouchUp += (o, e) => School_Click(MagicSchool.Fire);
            ...
            IceButton.TouchUp += (o, e) => School_Click(MagicSchool.Ice);
            ...
            LightningButton.TouchUp += (o, e) => School_Click(MagicSchool.Lightning);
            ...
            WindButton.TouchUp += (o, e) => School_Click(MagicSchool.Wind);
            ...
            HolyButton.TouchUp += (o, e) => School_Click(MagicSchool.Holy);
            ...
            DarkButton.TouchUp += (o, e) => School_Click(MagicSchool.Dark);
            ...
            PhantomButton.TouchUp += (o, e) => School_Click(MagicSchool.Phantom);
            ...
            WeaponSkillsButton.TouchUp += (o, e) => School_Click(MagicSchool.WeaponSkills);
            ...
            FirePage.FreeDrag += Page_DoFreeDrag;
            ...
            IcePage.FreeDrag += Page_DoFreeDrag;
            ...
            LightningPage.FreeDrag += Page_DoFreeDrag;
            ...
            WindPage.FreeDrag += Page_DoFreeDrag;
            ...
            HolyPage.FreeDrag += Page_DoFreeDrag;
            ...
            DarkPage.FreeDrag += Page_DoFreeDrag;
            ...
            PhantomPage.FreeDrag += Page_DoFreeDrag;
            ...
            WeaponSkillsPage.FreeDrag += Page_DoFreeDrag;
        ...
        private void School_Click(MagicSchool school)
        {
        ...
        public void Page_DoFreeDrag(object sender, TouchEventArgs e)
        {
    ...
    public sealed class MagicCell : DXControl
    {
        ...
        public DXImageControl Image, Image1, KeyImage;     //技能图标
        ...
        public MagicCell()
        {
            ...
            Image.TouchUp += (s, e) => Image_MouseClick();   //技能图标鼠标点击
            ...
            KeyImage = new DXImageControl             //快捷键标签
            {
                LibraryFile = LibraryFile.UI1,
                Parent = Image,
                IsControl = false,
