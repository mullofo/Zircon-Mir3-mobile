    ...
    public sealed class MainPanel : DXImageControl
    {
        ...
        public MainPanel()
        {
            ...
            ExperienceBar.AfterDraw += (o, e) =>  //在经验槽底图前面绘制
            {
                ...
                ExperienceBar.Library.Draw(1166, ExperienceBar.DisplayArea.X + 3, ExperienceBar.DisplayArea.Y + 2 + offset, Color.White, area, 1F, ImageType.Image, uiOffsetX: UI_Offset_X);
            };
            ...
            HealthBar.BeforeDraw += (o, e) =>
            {
                ...
                int offset = (int)(image.Height * (1.0 - percent));
                Rectangle area = new Rectangle(0, offset, image.Width, image.Height - offset);
                ExperienceBar.Library.Draw(1163, HealthBar.DisplayArea.X, HealthBar.DisplayArea.Y + offset, Color.White, area, 1F, ImageType.Image, uiOffsetX: UI_Offset_X);
            };
            ...
            ManaBar.BeforeDraw += (o, e) =>
            {
                ...
                int offset = (int)(image.Height * (1.0 - percent));
                Rectangle area = new Rectangle(0, offset, image.Width, image.Height - offset);
                ExperienceBar.Library.Draw(1164, ManaBar.DisplayArea.X, ManaBar.DisplayArea.Y + offset, Color.White, area, 1F, ImageType.Image, uiOffsetX: UI_Offset_X);
            };
            ...
            BagWeightBar.BeforeDraw += (o, e) =>
            {
                ...
                int offset = (int)(image.Height * (1.0 - percent));
                Rectangle area = new Rectangle(0, offset, image.Width, image.Height - offset);
                ExperienceBar.Library.Draw(1167, BagWeightBar.DisplayArea.X + 3, BagWeightBar.DisplayArea.Y + 2 + offset, Color.White, area, 1F, ImageType.Image, uiOffsetX: UI_Offset_X);
            };
            ...
            CharacterButton.MouseClick += (o, e) => GameScene.Game.CharacterBox.Visible = !GameScene.Game.CharacterBox.Visible;
            ...
            {
                Parent = this,
                ForeColour = Color.FromArgb(255, 0, 255, 0),
                Outline = true,
                OutlineColour = Color.Black,
                DrawFormat = TextFormatFlags.VerticalCenter | TextFormatFlags.HorizontalCenter,
                Visible = true
            ...
            {
                PetModeLabel.Location = new Point(927, 28);
            };
