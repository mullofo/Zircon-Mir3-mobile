...
namespace Client.Scenes.Views
{
    ...
    public sealed class BigPatchDialog : DXWindow
    {
        ...
        /// 常用选项
        /// </summary>
        public class DXCommonlyTab : DXControl
        {
            #region Properites
            /// <summary>
            /// 常用分组
            ...
            /// 自动幽灵盾
            /// </summary>
            public DXCheckBox AutoResistance;
            /// <summary>
            /// 自动移花接玉
            /// </summary>
            ...
            public DXCommonlyTab()
            {
                ...
                Border = true;
                int x = 10, y = 30, Xspac = 85, Yspac = 35;
                ...
                GroupNormal.Size = new Size(ChkNormals.Length * Xspac + 10 * 2, y);
                #endregion
                ...
                GroupWeather.Location = new Point(GroupNormal.Location.X + GroupNormal.Size.Width, GroupNormal.Location.Y);
                CombWeather = new DXComboBox
                {
                    Parent = GroupWeather,
                };
                CombWeather.Location = new Point(x, y);
                new DXListBoxItem
                {
                ...
                GroupWeather.Size = new Size(CombWeather.Size.Width + x * 2, y + Yspac);
                #endregion
                ...
                {
                    Parent = this,
                    Size = new Size(425, 32),
                    Location = new Point(5, GroupNormal.Location.Y + GroupNormal.Size.Height - 10),
                    Name = { Text = "战士".Lang() },
                    Visible = false,
                };
                ...
                // 战士
                x = 10; y = 30;
                AutoFlamingSword = CreateCheckBox(Warrior, "自动烈火".Lang(), x, y, (o, e) =>
                {
                ...
                AutoDragobRise = CreateCheckBox(Warrior, "自动翔空".Lang(), x + Xspac, y, (o, e) =>
                {
                ...
                AutoBladeStorm = CreateCheckBox(Warrior, "自动莲月".Lang(), x + Xspac + Xspac, y, (o, e) =>
                {
                ...
                AutoDefiance = CreateCheckBox(Warrior, "自动铁布衫".Lang(), x + Xspac + Xspac + Xspac, y, (o, e) =>
                {
                ...
                AutoMight = CreateCheckBox(Warrior, "自动破血".Lang(), x, y += Yspac, (o, e) =>
                {
                ...
                AutoCombo = CreateCheckBox(Warrior, "连招".Lang(), x + Xspac, y, (o, e) =>
                {
                ...
                ComboType.Location = new Point(x + Xspac + Xspac, y);
                ...
                Combo1.Location = new Point(x, y += Yspac);
                ...
                Combo2.Location = new Point(x + Xspac, y);
                ...
                Combo3.Location = new Point(x + Xspac + Xspac, y);
                ...
                Combo4.Location = new Point(x + Xspac + Xspac + Xspac, y);
                ...
                Combo5.Location = new Point(x, y += Yspac);

                Warrior.Size = new Size(4 * Xspac + 10 * 2, y);
                #endregion
                #region 法师
                ////////////////////////////////////////////////
                // 法师
                x = 10; y = 30;
                AutoMagicShield = CreateCheckBox(Wizard, "自动魔法盾".Lang(), x, y, (o, e) =>
                {
                    BigPatchConfig.AutoMagicShield = AutoMagicShield.Checked;
                }, BigPatchConfig.AutoMagicShield);
                AutoRenounce = CreateCheckBox(Wizard, "自动凝血".Lang(), x + Xspac, y, (o, e) =>
                {
                ...
                Wizard.Size = new Size(4 * Xspac + 10 * 2, y + Yspac);
                #endregion
                #region 道士
                /////////////////////////////////////////////////
                // 道士
                x = 10; y = 30;
                AutoPoisonDust = CreateCheckBox(Taoist, "自动换毒".Lang(), x, y, (o, e) =>
                {
                    BigPatchConfig.AutoPoisonDust = AutoPoisonDust.Checked;
                }, BigPatchConfig.AutoPoisonDust);
                AutoAmulet = CreateCheckBox(Taoist, "自动换符".Lang(), x + Xspac, y, (o, e) =>
                {
                    BigPatchConfig.AutoAmulet = AutoAmulet.Checked;
                }, BigPatchConfig.AutoAmulet);
                AutoResilience = CreateCheckBox(Taoist, "自动神圣".Lang(), x + Xspac + Xspac, y, (o, e) =>
                {
                    BigPatchConfig.AutoResilience = AutoResilience.Checked;
                }, BigPatchConfig.AutoResilience);
                AutoElementalSuperiority = CreateCheckBox(Taoist, "自动强魔".Lang(), x + Xspac + Xspac + Xspac, y, (o, e) =>
                {
                    BigPatchConfig.AutoElementalSuperiority = AutoElementalSuperiority.Checked;
                }, BigPatchConfig.AutoElementalSuperiority);
                AutoBloodLust = CreateCheckBox(Taoist, "自动猛虎".Lang(), x, y += Yspac, (o, e) =>
                {
                    BigPatchConfig.AutoBloodLust = AutoBloodLust.Checked;
                }, BigPatchConfig.AutoBloodLust);
                AutoResistance = CreateCheckBox(Taoist, "自动幽灵盾".Lang(), x + Xspac, y, (o, e) =>
                {
                    BigPatchConfig.AutoResistance = AutoResistance.Checked;
                }, BigPatchConfig.AutoResistance);
                AutoStrengthOfFaith = CreateCheckBox(Taoist, "自动移花".Lang(), x + Xspac + Xspac, y, (o, e) =>
                {
                    BigPatchConfig.AutoStrengthOfFaith = AutoStrengthOfFaith.Checked;
                }, BigPatchConfig.AutoStrengthOfFaith);
                ...
                Taoist.Size = new Size(4 * Xspac + 10 * 2, y + Yspac);
                #endregion
                #region 刺客
                /////////////////////////////////////////////////
                // 刺客
                x = 10; y = 30;
                AutoFourFlowers = CreateCheckBox(Assassin, "自动四花".Lang(), x, y, (o, e) =>
                {
                    BigPatchConfig.AutoFourFlowers = AutoFourFlowers.Checked;
                }, BigPatchConfig.AutoFourFlowers);
                AutoEvasion = CreateCheckBox(Assassin, "自动风之闪避".Lang(), x + Xspac, y, (o, e) =>
                {
                    BigPatchConfig.AutoEvasion = AutoEvasion.Checked;
                }, BigPatchConfig.AutoEvasion);
                AutoRagingWind = CreateCheckBox(Assassin, "自动风之守护".Lang(), x + Xspac + Xspac, y, (o, e) =>
                {
                    BigPatchConfig.AutoRagingWind = AutoRagingWind.Checked;
                }, BigPatchConfig.AutoRagingWind);
                Assassin.Size = new Size(4 * Xspac + 10 * 2, y + Yspac);
                #endregion
                #endregion
                ...
                NumbSkill1 = new DXNumberBox
                {
                    Parent = AutoSkill,
                    Size = new Size(90, 23),
                    ValueTextBox = { Size = new Size(40, 20) },
                    MaxValue = 50000,
                    MinValue = 1,
                    Value = BigPatchConfig.NumbSkill1,
                    UpButton = { Location = new Point(67, 0) }
                };
                NumbSkill1.ValueTextBox.ValueChanged += (o, e) =>
                {
                    BigPatchConfig.NumbSkill1 = NumbSkill1.Value;
                };
                NumbSkill1.Location = new Point(CombSkill1.Location.X, CombSkill1.Location.Y + CombSkill1.Size.Height + 5);
                ...
                Lab.Location = new Point(x, NumbSkill1.Location.Y + NumbSkill1.Size.Height + 5);
                ...
                NumbSkill2.Location = new Point(CombSkill2.Location.X, CombSkill2.Location.Y + CombSkill2.Size.Height + 5);
                ...
                AutoSkill.Size = new Size(AutoSkill_2.Location.X + AutoSkill_2.Size.Width + 10 * 2, NumbSkill2.Location.Y + NumbSkill2.Size.Height + 5);
                AutoSkill.Location = new Point(5, Size.Height - AutoSkill.Size.Height - 5);
                #endregion
                ...
                ChatFrame = new DXGroupBox
                {
                    ...
                    Location = new Point(AutoSkill.Location.X + AutoSkill.Size.Width + 10, AutoSkill.Location.Y),
                    Name = { Text = "聊天".Lang() },
                };
                ///////////////////////////////////
                x = 10; y = 30;
                ...
                IntervalLeft.Location = new Point(x, ChkAutoSayWords.Location.Y + ChkAutoSayWords.Size.Height + 5);

                AutoSayInterval = new DXNumberBox
                {
                    Change = 60000,
                    Parent = ChatFrame,
                    ValueTextBox = { Size = new Size(50, 20) },
                    MaxValue = 6000000,
                    Value = BigPatchConfig.AutoSayInterval,
                    MinValue = 60000,
                };
                AutoSayInterval.Location = new Point(IntervalLeft.Location.X + IntervalLeft.Size.Width + 5, IntervalLeft.Location.Y);
                ...
                IntervalRight.Location = new Point(AutoSayInterval.Location.X + AutoSayInterval.Size.Width + 5, IntervalLeft.Location.Y);
                ...
                InputBox = new DXTextView
                {
                    ...
                    ReadOnly = false,
                    MaxLength = 115,
                    Location = new Point(10, AutoSayInterval.Location.Y + AutoSayInterval.Size.Height + 5),
                    Opacity = 0.7F,
                };
                ...
                ChatFrame.Size = new Size(Size.Width - AutoSkill.Size.Width - 15, AutoSkill.Size.Height);
                InputBox.Size = new Size(ChatFrame.Size.Width - 10 * 2, ChatFrame.Size.Height - InputBox.Location.Y - 5);
                #endregion
                ...
                //    UpButton = { Location = new Point(67, 1) }
                //};
                ...
                ReloadConfig = new DXButton
                {
                    Parent = this,
                    Size = new Size(50, 18),
                    Location = new Point(GroupWeather.Location.X + GroupWeather.Size.Width + 10, GroupWeather.Location.Y + (GroupWeather.Size.Height / 2)),
                    ButtonType = ButtonType.SmallButton,
                    Label = {
                    Text = "重置".Lang(), },
                };
            ...
            public override void OnSizeChanged(Size oValue, Size nValue)
            {
                ...
                //if (Assassin != null)
                //{
                //    Assassin.Size = new Size(260, 157);
                ...
                //if (AutoSkill != null)
                //{
                //    AutoSkill.Size = new Size(260, 100);
                //    AutoSkill.Location = new Point(10, 215);
                //}

                //if (ChatFrame != null)
                //{
                //    ChatFrame.Size = new Size(260, 103);
                //    ChatFrame.Location = new Point(10, 305);
                //}

                //InputBox.Size = new Size(240, 40);
            ...
            public DXPlayerHelperTab()
            {
                ...
                AndroidPlayer.CheckedChanged += (o, e) =>
                {
                    ...
                    if (AndroidPlayer.Checked == true)   //如果 挂机等开启
                    {
                        ...
                        {
                            GameScene.Game.ReceiveChat("你已打开自动打怪，无法启动自动挂机".Lang(), MessageType.System);   //提示并跳过
        ...
        public class DXAutoPotionTab : DXControl
        {
            #region Properites
            /// <summary>
            /// 智能红分组
            ...
            public DXAutoPotionTab()
            {
                ...
                Border = true;
                int x = 5, y = 30, Yspac = 35;

                GroupMindHP = new DXGroupBox
                {
                    Parent = this,
                    Size = new Size(265, 95 + 152 - 28),
                ...
                {
                    Parent = GroupMindHP,
                    Location = new Point(chkMindHP.Location.X + chkMindHP.Size.Width + 5, chkMindHP.Location.Y),
                    Size = new Size(110, 23),
                    ValueTextBox = { Size = new Size(60, 20) },
                    MaxValue = 99999999,
                    MinValue = 0,
                    Value = BigPatchConfig.HP,
                    UpButton = { Location = new Point(87, 0) }
                };
                ...
                chkHPSynchro = CreateCheckBox(GroupMindHP, "智能调整最大血量%".Lang(), NumberMindHP.Location.X + NumberMindHP.Size.Width + 20, y, (o, e) =>
                {
                ...
                GroupMindHP.Size = new Size(chkHPSynchro.Location.X + chkHPSynchro.Size.Width + 5, NumberMindHP.Location.Y + NumberMindHP.Size.Height + 5);

                GroupCustomHP = new DXGroupBox
                {
                    Parent = this,
                    Size = new Size(265, 177 - 28),
                    Location = new Point(2, GroupMindHP.Location.Y + GroupMindHP.Size.Height),
                ...
                for (var i = 0; i < 8; i++)
                {
                    ...
                    {
                        Parent = GroupCustomHP,
                        Location = new Point(ChkCustomHMPs[i].Location.X + ChkCustomHMPs[i].Size.Width + 5, y),
                        Size = new Size(90, 23),
                        ValueTextBox = { Size = new Size(40, 20) },
                        MaxValue = 99999999,
                        MinValue = 0,
                    ...
                    {
                        Parent = GroupCustomHP,
                        Location = new Point(NumberCustomHMPs[i].Location.X + NumberCustomHMPs[i].Size.Width + 5, y),
                        Size = new Size(90, 18),
                        Tag = i
                    };
                    ...
                    x = CombConsumables[i].Location.X + CombConsumables[i].Size.Width + 5;
                    if ((i + 1) % 2 == 0)
                    {
                        x = 5;
                        y += Yspac;
                ...
                GroupCustomHP.Size = new Size(CombConsumables[1].Location.X + CombConsumables[1].Size.Width + 5, NumberCustomHMPs[3].Location.Y + NumberCustomHMPs[3].Size.Height + 5);
                ...
                {
                    Parent = this,
                    Size = new Size(265, 220 - 29),
                    Location = new Point(2, GroupCustomHP.Location.Y + GroupCustomHP.Size.Height),
                ...
                {
                    Parent = GroupMindMP,
                    Location = new Point(chkMindMP.Location.X + chkMindMP.Size.Width + 5, chkMindMP.Location.Y),
                    Size = new Size(110, 23),
                    ValueTextBox = { Size = new Size(60, 20) },
                    MaxValue = 99999999,
                    MinValue = 0,
                ...
                chkMPSynchro = CreateCheckBox(GroupMindMP, "智能调整最大蓝量%".Lang(), NumberMindMP.Location.X + NumberMindMP.Size.Width + 20, y, (o, e) =>
                {
                ...
                GroupMindMP.Size = new Size(chkMPSynchro.Location.X + chkMPSynchro.Size.Width + 5, NumberMindMP.Location.Y + NumberMindMP.Size.Height + 5);

                GroupCustomMP = new DXGroupBox
                {
                    Parent = this,
                    Size = new Size(265, 150 - 29),
                    Location = new Point(2, GroupMindMP.Location.Y + GroupMindMP.Size.Height),
                ...
                GroupCustomMP.Size = new Size(CombConsumables[9].Location.X + CombConsumables[9].Size.Width + 5, NumberCustomHMPs[11].Location.Y + NumberCustomHMPs[11].Size.Height + 5);

                #region 无用
                Other = new DXGroupBox
                {
                    Parent = this,
                    Size = new Size(265, 185),
        ...
        {
            public DXListBox LogList; [DllImport("kernel32.dll")]
        ...
        #region 魔法
        public class DXMagicHelperTab : DXControl
        {
            ...
            public DXMagicHelperTab()
            {
                ...
                MagicView.InsertColumn(0, "魔法名称".Lang(), 100, 25, "只显示已学过的技能".Lang());
                ...
                MagicView.InsertColumn(1, "锁人".Lang(), 50, 25, "设置自动锁定人".Lang());
                MagicView.InsertColumn(2, "锁怪".Lang(), 50, 25, "设置自动锁定怪".Lang());
                MagicView.InsertColumn(3, "毒符设定".Lang(), 100, 25, "道士的自动换符设置".Lang());
        ...
        public class DXMonBossListTab : DXControl
        {
            /// <summary>
            /// BOSS格子
            /// </summary>
            ...
            public DXMonBossListTab()
            {
                ...
                {
                    Parent = this,
                    Size = new Size(395, 225),
                    Location = new Point(10, 25),
                    ItemBorder = false,
                };
                BossView.InsertColumn(0, "怪物名称".Lang(), 260, 24, "怪物的名字".Lang());
                ...
                {
                    Location = new Point(BossView.Location.X, BossGroup.Location.Y + BossGroup.Size.Height + 5),
                    Parent = this,
                ...
                AddButton = new DXButton
                {
                    ...
                    Index = 1001,
                    Parent = this,
                    Location = new Point(NameTextBox.Location.X + NameTextBox.Size.Width + 20, NameTextBox.Location.Y),
                    Hint = "新增BOSS提醒",
                };
                AddButton.MouseClick += (o, e) =>
                {
                ...
                DelButton = new DXButton
                {
                    ...
                    Index = 1002,
                    Parent = this,
                    Location = new Point(AddButton.Location.X + 50, AddButton.Location.Y),
                    Hint = "删除现有BOSS提醒",
                };
                DelButton.MouseClick += (o, e) =>
                {
        ...
        /// 分页
        /// </summary>
        //public DXControl TabControl;
        private DXButton CommonlyButton, HelperButton, AutoPotionButton, MagicButton, MonBossButton;
        ...
        public BigPatchDialog()
        {
            ...
            //    Size = new Size(278, 430),
            //};

            CommonlyButton = new DXButton
            {
                Parent = TabBackGround,
                LibraryFile = LibraryFile.PhoneUI,
                Index = 1015,
                Location = new Point(10, 50),
                Label = { Text = "常用", Outline = true }
            };
            CommonlyButton.Tap += (o, e) =>
            {
                Commonly.Visible = true;
                Helper.Visible = false;
                AutoPotionPage.Visible = false;
                Magic.Visible = false;
                MonBoss.Visible = false;

                CommonlyButton.Index = 1015;
                HelperButton.Index = 1016;
                AutoPotionButton.Index = 1016;
                MagicButton.Index = 1016;
                MonBossButton.Index = 1016;
            };
            ...
            HelperButton = new DXButton
            {
                Parent = TabBackGround,
                LibraryFile = LibraryFile.PhoneUI,
                Index = 1016,
                Location = new Point(CommonlyButton.Location.X, CommonlyButton.Location.Y + CommonlyButton.Size.Height + 10),
                Label = { Text = "辅助", Outline = true }
            };
            HelperButton.Tap += (o, e) =>
            {
                Commonly.Visible = false;
                Helper.Visible = true;
                AutoPotionPage.Visible = false;
                Magic.Visible = false;
                MonBoss.Visible = false;

                CommonlyButton.Index = 1016;
                HelperButton.Index = 1015;
                AutoPotionButton.Index = 1016;
                MagicButton.Index = 1016;
                MonBossButton.Index = 1016;
            };
            ...
            AutoPotionButton = new DXButton
            {
                Parent = TabBackGround,
                LibraryFile = LibraryFile.PhoneUI,
                Index = 1016,
                Location = new Point(HelperButton.Location.X, HelperButton.Location.Y + HelperButton.Size.Height + 10),
                Label = { Text = "保护", Outline = true }
            };
            AutoPotionButton.Tap += (o, e) =>
            {
                Commonly.Visible = false;
                Helper.Visible = false;
                AutoPotionPage.Visible = true;
                Magic.Visible = false;
                MonBoss.Visible = false;

                CommonlyButton.Index = 1016;
                HelperButton.Index = 1016;
                AutoPotionButton.Index = 1015;
                MagicButton.Index = 1016;
                MonBossButton.Index = 1016;
            };
            ...
            MagicButton = new DXButton
            {
                ...
                LibraryFile = LibraryFile.PhoneUI,
                Index = 1016,
                Location = new Point(AutoPotionButton.Location.X, AutoPotionButton.Location.Y + AutoPotionButton.Size.Height + 10),
                Label = { Text = "魔法", Outline = true }
            };
            MagicButton.Tap += (o, e) =>
            {
                Commonly.Visible = false;
            ...
            MonBossButton = new DXButton
            {
                Parent = TabBackGround,
                LibraryFile = LibraryFile.PhoneUI,
                Index = 1016,
                Location = new Point(MagicButton.Location.X, MagicButton.Location.Y + MagicButton.Size.Height + 10),
                Label = { Text = "怪物", Outline = true }
            };
            MonBossButton.Tap += (o, e) =>
            {
                Commonly.Visible = false;
                Helper.Visible = false;
                AutoPotionPage.Visible = false;
                Magic.Visible = false;
                MonBoss.Visible = true;

                CommonlyButton.Index = 1016;
                HelperButton.Index = 1016;
                AutoPotionButton.Index = 1016;
                MagicButton.Index = 1016;
                MonBossButton.Index = 1015;
            };
        ...
        public void AutoSkills()
        {
            ...
            string[] magicstr = { "风之闪避", "风之守护", "魔法盾", "凝血离魂", "神圣战甲术", "猛虎强势", "强魔震法", "幽灵盾", "阴阳法环", "移花接玉", "铁布衫", "破血狂杀" };
            ...
            {
                if (BigPatchConfig.AutoResilience && magicDics.TryGetValue("神圣战甲术", out bool value))
                {
                    if (GameScene.Game.User.Buffs.All(x => x.Type != BuffType.Resilience))
                    {
                        ...
                        GameScene.Game.UseMagic(MagicType.Resilience);
                ...
                if (BigPatchConfig.AutoBloodLust && magicDics.TryGetValue("猛虎强势", out value))
                {
                    if (GameScene.Game.User.Buffs.All(x => x.Type != BuffType.BloodLust))
                    {
                        var ob = GameScene.Game.MagicObject;
                        var mob = GameScene.Game.MouseObject;
                        var lo = GameScene.Game.MapControl.MouseLocation;
                        ...
                        GameScene.Game.MouseObject = null;
                        GameScene.Game.MapControl.MouseLocation = ZoomRate == 1F ? new Point((CEnvir.Target.Width / 2), (CEnvir.Target.Height / 2)) : new Point((int)Math.Round(((CEnvir.Target.Width / 2) - UI_Offset_X) / ZoomRate), (int)Math.Round((CEnvir.Target.Height / 2) / ZoomRate));
                        GameScene.Game.UseMagic(MagicType.BloodLust);
                ...
                if (BigPatchConfig.AutoElementalSuperiority && magicDics.TryGetValue("强魔震法", out value))
                {
                    if (GameScene.Game.User.Buffs.All(x => x.Type != BuffType.ElementalSuperiority))
                    {
                        var ob = GameScene.Game.MagicObject;
                        var mob = GameScene.Game.MouseObject;
                        var lo = GameScene.Game.MapControl.MouseLocation;
                        ...
                        GameScene.Game.MouseObject = null;
                        GameScene.Game.MapControl.MouseLocation = ZoomRate == 1F ? new Point((CEnvir.Target.Width / 2), (CEnvir.Target.Height / 2)) : new Point((int)Math.Round(((CEnvir.Target.Width / 2) - UI_Offset_X) / ZoomRate), (int)Math.Round((CEnvir.Target.Height / 2) / ZoomRate));
                        GameScene.Game.UseMagic(MagicType.ElementalSuperiority);
                ...
                if (BigPatchConfig.AutoResistance && magicDics.TryGetValue("幽灵盾", out value))
                {
                    if (GameScene.Game.User.Buffs.All(x => x.Type != BuffType.MagicResistance))
                    {
                        var ob = GameScene.Game.MagicObject;
                        var mob = GameScene.Game.MouseObject;
                        var lo = GameScene.Game.MapControl.MouseLocation;
                        ...
                        GameScene.Game.MouseObject = null;
                        GameScene.Game.MapControl.MouseLocation = ZoomRate == 1F ? new Point((CEnvir.Target.Width / 2), (CEnvir.Target.Height / 2)) : new Point((int)Math.Round(((CEnvir.Target.Width / 2) - UI_Offset_X) / ZoomRate), (int)Math.Round((CEnvir.Target.Height / 2) / ZoomRate));
                        GameScene.Game.UseMagic(MagicType.MagicResistance);
                ...
                if (BigPatchConfig.AutoCelestial && magicDics.TryGetValue("阴阳法环", out value))//自动阴阳法环
                {
                ...
                if (BigPatchConfig.AutoStrengthOfFaith && magicDics.TryGetValue("移花接玉", out value))//自动阴阳法环
                {
                    if (GameScene.Game.User.Buffs.All(x => x.Type != BuffType.StrengthOfFaith))
                    {
            ...
            #region 自动技能
            //如果不挂机，持续施法才能使用
            if (!BigPatchConfig.AndroidPlayer && (GameScene.Game.ContinuouslyMagic || GameScene.Game.AutoAttack))
            {
                if (GameScene.Game.AutoAttack && (MapObject.MagicObject == null || MapObject.MagicObject.Dead))
                {
                    GameScene.Game.SetMagicTargetObject(GameScene.Game.MagicBarBox.SelectPlayer ? ObjectType.Player : ObjectType.Monster);
                }


                if (MapObject.MagicObject != null && !MapObject.MagicObject.Dead)
                {
                    if (!GameScene.Game.MagicBarBox.PhysicalAttack)
                    {
                        if (GameScene.Game.CanContinuouslyMagic(GameScene.Game.ContinuouslyMagicType))
                        {
                            //如果目标在魔法范围，使用魔法
                            if (Functions.InRange(MapObject.MagicObject.CurrentLocation, MapObject.User.CurrentLocation, Globals.MagicRange - 1))
                            {
                                if (GameScene.Game.AutoAttack && Functions.Distance(MapObject.User.CurrentLocation, MapObject.MagicObject.CurrentLocation) > 7)
                                    return;
                                if (GameScene.Game.ContinuouslyMagic || GameScene.Game.AutoAttack)
                    ...
                    {
                        if (GameScene.Game.AutoAttack)
                            MapObject.TargetObject = MapObject.MagicObject;
                    }
