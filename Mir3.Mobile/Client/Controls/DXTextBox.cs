...
namespace Client.Controls
{
    ...
    public class DXTextBox : DXControl
    {
        ...
        protected override void CreateTexture()
        {
            ...
            int width = (int)Math.Round(DisplayArea.Width * ZoomRate);
            int height = (int)Math.Round(DisplayArea.Height * ZoomRate);
            ...
            {
                TextRenderer.DrawText(Device.SpriteBatch, TextBox.TextDisplay(), font, outline: false, new Rectangle(0, 0, width, height), ForeColour, TextFormatFlags.WordBreak);
            }
        ...
        public override void OnMouseUp(MouseEventArgs e)
        {
            ...
            _ = e.X;
            _ = base.DisplayArea.X;
            _ = e.Y;
            _ = base.DisplayArea.Y;
            MouseButtons button = e.Button;
            if (button != MouseButtons.Left)
            {
                _ = 2097152;
        ...
        {
            Game1.Native.ShowInputField(ActiveTextBox.TextBox.Text);
        }
        /// <summary>
        /// 焦点可行
        /// </summary>
