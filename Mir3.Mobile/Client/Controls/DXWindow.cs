...
namespace Client.Controls
{
    ...
    public abstract class DXWindow : DXControl
    {
        ...
        //public override void OnZoomRateChanged(float oValue, float nValue)
        //{
        //    UpdateClientArea();
        //    UpdateLocations();
        //}
        ...
        protected override void CreateTexture()
        {
            ...
            {
                WindowTexture = new Texture(DXManager.Device, DXManager.Parameters.BackBufferWidth, DXManager.Parameters.BackBufferHeight, 1, Usage.RenderTarget, Microsoft.Xna.Framework.Graphics.SurfaceFormat.Color, Pool.Default);
        ...
        protected void DrawWindow()
        {
            ...
            PresentMirImage(WindowTexture, Parent, DisplayArea, ForeColour, this, zoomRate: ZoomRate, uiOffsetX: UI_Offset_X);
