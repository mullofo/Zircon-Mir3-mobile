...
namespace Client.Controls
{
    ...
    public sealed class DXColourPicker : DXWindow  //颜色选择器
    {
        ...
        public DXColourPicker()
        {
            ...
            AfterDraw += (o, e) =>
            {
                PresentMirImage(DXManager.ColourPallete, ColourScaleBox, ColourScaleBox.DisplayArea, Color.White, this, zoomRate: ZoomRate, uiOffsetX: UI_Offset_X);
            };
        ...
        private void DOCancelButton(object sender, TouchEventArgs e)
        {
            Target.BackColour = PreviousColour;
            Dispose();
        }
