...
namespace Client.Controls
{
    ...
    public sealed class DXComboBox : DXControl
    {
        ...
        public const int DefaultNormalHeight = 20;   //默认正常高度
        ...
        public DXComboBox()
        {
            ...
            DownArrow.TouchDown += DownArrow_MouseClick;
            ...
            SelectedLabel.MouseClick += DownArrow_MouseClick;
        ...
        #region Methods
        private void DownArrow_MouseClick(object sender, TouchEventArgs e)
        {
            Showing = !Showing;
        }
        /// <summary>
