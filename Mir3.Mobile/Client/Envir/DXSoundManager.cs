...
namespace Client.Envir
{
    ...
    public static class DXSoundManager
    {
        ...
        {
            //韩版 Login登录场景背景音乐
            [SoundIndex.Main] = new DXSound(SoundPath + @"Main.wav", SoundType.Music) { Loop = true },
            ...
            [SoundIndex.ItemGold] = new DXSound(SoundPath + @"106.wav", SoundType.System),
            ...
            [SoundIndex.ReigningStepStart] = new DXSound(SoundPath + @"M109-1.wav", SoundType.Magic),
            ...
            [SoundIndex.FlashOfLightStart] = new DXSound(SoundPath + @"M123-1.wav", SoundType.Magic),
            [SoundIndex.FlashOfLightEnd] = new DXSound(SoundPath + @"M123-3.wav", SoundType.Magic),
            ...
            [SoundIndex.IceRainStart] = new DXSound(SoundPath + @"40360.wav", SoundType.Magic),
            #endregion

            #region Monsters 怪物音乐
            ...
            [SoundIndex.news] = new DXSound(SoundPath + @"news.wav", SoundType.Player),

            #region 145 场景相关音效

            #region Video  145动画登录音乐
            [SoundIndex.Wemade145] = new DXSound(SoundPath + @"145Wemade.wav", SoundType.System),         //开场动画音效
            [SoundIndex.StartGame145] = new DXSound(SoundPath + @"145StartGame.wav", SoundType.System),   //点开始游戏动画音效
            [SoundIndex.CreateChr145] = new DXSound(SoundPath + @"145CreateChr.wav", SoundType.System),  //点创建角色动画音效
            [SoundIndex.SelChrRe145] = new DXSound(SoundPath + @"145SelChrRe1.wav", SoundType.System),   //创建角色场景返回选人场景动画音效
            #endregion

            #region 145登录场景音效
            [SoundIndex.LoginSceneBgm145] = new DXSound(SoundPath + @"145Opening.wav", SoundType.Music) { Loop = true }, //Login登录场景背景音效
            #endregion

            #region 145选人场景音效
            [SoundIndex.SelChrBgm145] = new DXSound(SoundPath + @"145SelChrBgm.wav", SoundType.Music) { Loop = true },  //选人场景背景音乐
            [SoundIndex.SelectWarriorMale145] = new DXSound(SoundPath + @"145JMMSel.wav", SoundType.System),             //战士男 角色选中音效
            [SoundIndex.SelectWarriorFemale145] = new DXSound(SoundPath + @"145JWMSel.wav", SoundType.System),           //战士女 角色选中音效
            [SoundIndex.SelectWizardMale145] = new DXSound(SoundPath + @"145SMMSel.wav", SoundType.System),              //法师男 角色选中音效
            [SoundIndex.SelectWizardFemale145] = new DXSound(SoundPath + @"145SWMSel.wav", SoundType.System),            //法师女 角色选中音效
            [SoundIndex.SelectTaoistMale145] = new DXSound(SoundPath + @"145DMMSel.wav", SoundType.System),              //道士男 角色选中音效
            [SoundIndex.SelectTaoistFemale145] = new DXSound(SoundPath + @"145DWMSel.wav", SoundType.System),            //道士女 角色选中音效

            [SoundIndex.CreateChrBgm145] = new DXSound(SoundPath + @"145CreateChrBgm.wav", SoundType.Music) { Loop = true }, //创建角色背景音乐    
            [SoundIndex.CreateWarriorMale145] = new DXSound(SoundPath + @"145JMCre.wav", SoundType.System),   //战士男 选中音效
            [SoundIndex.CreateWarriorFemale145] = new DXSound(SoundPath + @"145JWCre.wav", SoundType.System), //战士女 选中音效
            [SoundIndex.CreateWizardMale145] = new DXSound(SoundPath + @"145SMCre.wav", SoundType.System),    //法师男 选中音效
            [SoundIndex.CreateWizardFemale145] = new DXSound(SoundPath + @"145SWCre.wav", SoundType.System),  //法师女 选中音效
            [SoundIndex.CreateTaoistMale145] = new DXSound(SoundPath + @"145DMCre.wav", SoundType.System),    //道士男 选中音效
            [SoundIndex.CreateTaoistFemale145] = new DXSound(SoundPath + @"145DWCre.wav", SoundType.System),  //道士女 选中音效
            #endregion

            #endregion

            [SoundIndex.Mobile] = new DXSound(SoundPath + @"mobile.wav", SoundType.Music),

            [SoundIndex.gxfc] = new DXSound(SoundPath + @"gxfc.wav", SoundType.Player) { Loop = true },
        };
        #endregion
        ...
        public static void Stop(string SoundName)
        {
            ...
            if (!DiySoundList.TryGetValue(SoundName, out sound)) return;
        ...
        /// <returns></returns>
        public static DXSound AddDiySound(string SoundName, SoundType SoundType)
        {
            DXSound sound = null;
            if (SoundName == "") return sound;
            if (!DiySoundList.TryGetValue(SoundName, out sound))
            {
                sound = new DXSound(SoundPath + SoundName, SoundType);
                if (SoundType == SoundType.Music) sound.Loop = true;
                DiySoundList.Add(SoundName, sound);
            }
            return sound;
        }
        /// <summary>
        ...
        /// <param name="mirAnimationSound">自定义的音效</param>
        /// <returns></returns>
        public static DXSound AddDiySound(int MonId, MirAnimationSound mirAnimationSound)
        {
            ...
            switch (mirAnimationSound)
            {
                case MirAnimationSound.AttackSound:
                    ...
                    if (SoundString == null) return sound;
                    break;
            ...
            if (!DiySoundList.TryGetValue(SoundString, out sound))
            {
                ...
                DiySoundList.Add(SoundString, sound);
            }
            return sound;
        }
        ...
        public static void Play(SoundIndex index)
        {
            ...
            catch (Exception ex) { CEnvir.SaveError(ex.ToString()); }
        }
        ...
        public static void AdjustVolume()
        {
            ...
            foreach (KeyValuePair<string, DXSound> pair in DiySoundList)
                pair.Value.SetVolume();
        }
        /// <summary>
        /// 获取音量
        ...
        public static int GetVolume(SoundType type)
        {
            ...
            //        volume = (!Config.OtherMusic) ? 0 : Math.Max(0, Math.Min(100, Config.OtherMusicVolume));
            //        break;
            //    case SoundType.Music:
            //        volume = (!Config.BGM) ? 0 : Math.Max(0, Math.Min(100, Config.BGMVolume));
            //        break;
            ...
            return type switch
            {
                SoundType.System => Math.Max(0, Math.Min(100, Config.OtherMusicVolume)),
                SoundType.Music => Math.Max(0, Math.Min(100, Config.BGMVolume)),
                SoundType.Player => Math.Max(0, Math.Min(100, Config.OtherMusicVolume)),
                SoundType.Monster => Math.Max(0, Math.Min(100, Config.OtherMusicVolume)),
                SoundType.Magic => Math.Max(0, Math.Min(100, Config.OtherMusicVolume)),
            };
        }
        /// <summary>
        /// 卸载
