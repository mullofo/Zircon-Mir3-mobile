...
namespace Client.Models
{
    ...
    public sealed class MonsterObject : MapObject
    {
        ...
        public override void DrawHealth()
        {
            ...
            Color color = !string.IsNullOrEmpty(PetOwner) ? Color.Yellow : Config.MonHealthColour;

            library.Draw(80, DrawX, DrawY - 55, Color.White, false, 1F, ImageType.Image, zoomRate: CEnvir.UIScale, uiOffsetX: CEnvir.UI_Offset_X);
            library.Draw(79, DrawX + 1, DrawY - 55 + 1, color, new Rectangle(0, 0, (int)(size.Width * percent), size.Height), 1F, ImageType.Image, zoomRate: CEnvir.UIScale, uiOffsetX: CEnvir.UI_Offset_X);
            ...
            if (HPratioLabel != null && CEnvir.Now <= DrawHealthTime)     //数字显血
            {
                ...
                int y = DrawY - 55 - HPratioLabel.Size.Height;
