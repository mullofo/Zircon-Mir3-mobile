...
namespace LibraryEditor
{
    ...
    public sealed class MLibraryV1
    {
        ...
        public void Initialize()
        {
            ...
            {
                MessageBox.Show("版本错误, 应为lib版本: " + LibVersion.ToString() + " 打开失败: " + CurrentVersion.ToString() + ".", "打开失败", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1);
                return;
            }
