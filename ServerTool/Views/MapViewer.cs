...
namespace Server.Views.DirectX
{
    ...
    public sealed class MirLibrary : IDisposable
    {
        ...
        public const byte LibVersion = 2;
        //加密相关
        public bool Crypt;
        ...
        public void ReadLibrary()
        {
            ...
            using (BinaryReader reader = new BinaryReader(mstream))
            {
                ...
                for (int i = 0; i < Images.Length; i++)
                {
                    ...
                    Images[i] = new MirImage(reader, Manager, currentVersion, isZirconVersion) { ImageTextureType = imageTextureType, };
                }
            }
    ...
    public sealed class MirImage : IDisposable
    {
        ...
        public MirImage(BinaryReader reader, DXManager manager, int version, bool isZirconVersion = false)
        {
