    ...
    public sealed class CraftResult : DXWindow
    {
        ...
        public CraftResult()
        {
            ...
            RemainingTimeText.BeforeDraw += (sender, args) =>
            {
                ...
                PresentTexture(image.Image, this, new Rectangle(CraftResultBackGround.DisplayArea.X + 25, CraftResultBackGround.DisplayArea.Y + 115, (int)(image.Width * percent), image.Height),
