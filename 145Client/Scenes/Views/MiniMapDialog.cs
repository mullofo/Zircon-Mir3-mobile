...
using System.Windows.Forms;  //使用 坐标形式
...
namespace Client.Scenes.Views
{
    ...
    public sealed class MiniMapDialog : DXWindow
    {
        ...
        public MiniMapDialog()
        {
            ...
            Translucent.MouseClick += (o, e) =>
            {
                if (Image.Opacity == 1.0F)
                {
                    ...
                    GameScene.Game.BigMapBox.Image.Opacity = 0.7F;
                    GameScene.Game.BigMapBox.Image.ImageOpacity = 0.7F;
                }
                else
                {
                    Image.Opacity = 1.0F;
                    Image.ImageOpacity = 1.0F;
                    GameScene.Game.BigMapBox.Image.Opacity = 1.0F;
                    GameScene.Game.BigMapBox.Image.ImageOpacity = 1.0F;
                }
            };
		...
		private void MapControl_MapInfoChanged(object sender, EventArgs e)
        {
            ...
            Image.Size = new Size(Image.Size.Width, Image.Size.Height);
