    ...
    public sealed class CompanionDialog : DXWindow
    {
        ...
        public CompanionDialog()
        {
            ...
            ExpBar.AfterDraw += (o, e) =>
            {
                ...
                PresentTexture(image.Image, CompanionBackGround, new Rectangle(ExpBar.DisplayArea.X - 2, ExpBar.DisplayArea.Y + 1, (int)(image.Width * percent), image.Height), Color.White, ExpBar);
            };
            ...
            HungerBar.AfterDraw += (o, e) =>
            {
                ...
                PresentTexture(image.Image, CompanionBackGround, new Rectangle(HungerBar.DisplayArea.X - 2, HungerBar.DisplayArea.Y + 1, (int)(image.Width * percent), image.Height), Color.White, HungerBar);
            };
            ...
            WeightBar.AfterDraw += (o, e) =>
            {
                ...
                PresentTexture(image.Image, GridBackGround, new Rectangle(WeightBar.DisplayArea.X - 2, WeightBar.DisplayArea.Y + 1, (int)(image.Width * percent), image.Height), Color.White, WeightBar);
            };
