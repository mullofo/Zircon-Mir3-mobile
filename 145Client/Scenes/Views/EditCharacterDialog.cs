    ...
    public sealed class EditCharacterDialog : DXWindow
    {
        ...
        public EditCharacterDialog()
        {
            ...
            CharacterNameHelpLabel = new DXLabel
            {
                ...
                Parent = this,
                Text = "[?]",
                Hint = $"EditCharacter.NameHelp".Lang(Globals.MinCharacterNameLength, Globals.MaxCharacterNameLength),
            };
        ...
        public void Confirm()
        {
            switch (Change)
            {
                case ChangeType.GenderChange:
                    ...
                    {
                        GameScene.Game.ReceiveChat($"EditCharacter.GenderChange".Lang(SelectedGender), MessageType.System);
                        return;
                    }
