...
namespace Client.Scenes.Views
{
    ...
    public sealed class MarketSearchDialog : DXWindow
    {
        ...
        public DXButton WeaponButton, ArmourButton, HelmetButton, NecklaceButton, BraceletButton, RingButton, ShoesButton, BookButton, OtherButton, ConsumableButton, OreButton, MaterialButton;
        ...
        public MarketSearchDialog()
        {
            ...
            WeaponButton = new DXButton
            {
                Parent = this,
                LibraryFile = LibraryFile.UI1,
                Index = 1892,
                Location = new Point(9, 43),
                Label = { Text = "武器".Lang(), ForeColour = Color.White, },
            };
            WeaponButton.MouseClick += (o, e) =>
            {
                Search(ItemType.Weapon);
            };

            ArmourButton = new DXButton
            {
                Parent = this,
                LibraryFile = LibraryFile.UI1,
                Index = 1892,
                Location = new Point(9, 67),
                Label = { Text = "衣服".Lang(), ForeColour = Color.White, },
            };
            ArmourButton.MouseClick += (o, e) =>
            {
                Search(ItemType.Armour);
            };

            HelmetButton = new DXButton
            {
                Parent = this,
                LibraryFile = LibraryFile.UI1,
                Index = 1892,
                Location = new Point(9, 92),
                Label = { Text = "头盔".Lang(), ForeColour = Color.White, },
            };
            HelmetButton.MouseClick += (o, e) =>
            {
                Search(ItemType.Helmet);
            };

            NecklaceButton = new DXButton
            {
                Parent = this,
                LibraryFile = LibraryFile.UI1,
                Index = 1892,
                Location = new Point(9, 117),
                Label = { Text = "项链".Lang(), ForeColour = Color.White, },
            };
            NecklaceButton.MouseClick += (o, e) =>
            {
                Search(ItemType.Necklace);
            };

            BraceletButton = new DXButton
            {
                Parent = this,
                LibraryFile = LibraryFile.UI1,
                Index = 1892,
                Location = new Point(9, 142),
                Label = { Text = "手镯".Lang(), ForeColour = Color.White, },
            };
            BraceletButton.MouseClick += (o, e) =>
            {
                Search(ItemType.Bracelet);
            };

            RingButton = new DXButton
            {
                Parent = this,
                LibraryFile = LibraryFile.UI1,
                Index = 1892,
                Location = new Point(9, 167),
                Label = { Text = "戒指".Lang(), ForeColour = Color.White, },
            };
            RingButton.MouseClick += (o, e) =>
            {
                Search(ItemType.Ring);
            };

            ShoesButton = new DXButton
            {
                Parent = this,
                LibraryFile = LibraryFile.UI1,
                Index = 1892,
                Location = new Point(9, 192),
                Label = { Text = "鞋子".Lang(), ForeColour = Color.White, },
            };
            ShoesButton.MouseClick += (o, e) =>
            {
                Search(ItemType.Shoes);
            };

            BookButton = new DXButton
            {
                Parent = this,
                LibraryFile = LibraryFile.UI1,
                Index = 1892,
                Location = new Point(9, 217),
                Label = { Text = "书籍".Lang(), ForeColour = Color.White, },
            };
            BookButton.MouseClick += (o, e) =>
            {
                Search(ItemType.Book);
            };

            ConsumableButton = new DXButton
            {
                Parent = this,
                LibraryFile = LibraryFile.UI1,
                Index = 1892,
                Location = new Point(9, 242),
                Label = { Text = "消耗品".Lang(), ForeColour = Color.White, },
            };
            ConsumableButton.MouseClick += (o, e) =>
            {
                Search(ItemType.Consumable);
            };

            OreButton = new DXButton
            {
                Parent = this,
                LibraryFile = LibraryFile.UI1,
                Index = 1892,
                Location = new Point(9, 267),
                Label = { Text = "矿石".Lang(), ForeColour = Color.White, },
            };
            OreButton.MouseClick += (o, e) =>
            {
                Search(ItemType.Ore);
            };

            MaterialButton = new DXButton
            {
                Parent = this,
                LibraryFile = LibraryFile.UI1,
                Index = 1892,
                Location = new Point(9, 292),
                Label = { Text = "材料".Lang(), ForeColour = Color.White, },
            };
            MaterialButton.MouseClick += (o, e) =>
            {
                Search(ItemType.Material);
            };


            OtherButton = new DXButton
            {
                Parent = this,
                LibraryFile = LibraryFile.UI1,
                Index = 1892,
                Location = new Point(9, 316),
                Label = { Text = "全部".Lang(), ForeColour = Color.White, },
            };
            OtherButton.MouseClick += (o, e) =>
            {
            ...
            SearchRows = new MarketPlaceRow[13];
            ...
            for (int i = 0; i < SearchRows.Length; i++)
            {
                ...
                {
                    Parent = this,
                    Location = new Point(127, 83 + i * 19),
                };
                SearchRows[index].MouseClick += (o, e) => { SelectedRow = SearchRows[index]; };
                SearchRows[index].MouseWheel += SearchScrollBar.DoMouseWheel;
                SearchRows[index].MouseEnter += (o, e) => { GameScene.Game.MouseItem = SearchRows[index].MarketInfo?.Item; };
