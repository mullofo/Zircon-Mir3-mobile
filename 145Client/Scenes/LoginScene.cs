...
namespace Client.Scenes
{
    ...
    public class LoginScene : DXScene
    {
        ...
        /// 服务器端口
        /// </summary>
        public int ServerPort => NetworkConfig.UseNetworkConfig ? NetworkConfig.Port : Config.DefaultPort;
        #endregion
        ...
        public LoginScene(Size size) : base(size)
        {
            ...
            LoginBox.Location = new Point((Size.Width - LoginBox.Size.Width) / 2, background.DisplayArea.Bottom - 48);
        ...
        public void ReconnectTcpClient()
        {
            try
            {
                if (NetworkConfig.UseCloudShield)
                {
                    ...
                    //连接云盾
                    int shieldStatus = CEnvir.clinkStart(NetworkConfig.ShieldKey);
                    if (shieldStatus == 150)
                    {
        ...
        public sealed class LoginDialog : DXWindow
        {
            ...
            public DXButton LoginButton, QuitButton, NewAccountButton, ChangePasswordButton, ForgotPasswordLabel;
            ...
            public LoginDialog()
            {
                ...
                QuitButton.MouseClick += (o, e) => CEnvir.Target.Close();
                ...
                ForgotPasswordLabel = new DXButton  //找回密码
                {
                    Parent = this,
                    LibraryFile = LibraryFile.Interface1c145,
                    Index = 18,
                ...
                ForgotPasswordLabel.MouseEnter += (o, e) =>     //鼠标移动上去
                {
                    ForgotPasswordLabel.Index = 19;
                };
                ForgotPasswordLabel.MouseLeave += (o, e) =>   //鼠标离开
                {
                    ForgotPasswordLabel.Index = 18;
                };
