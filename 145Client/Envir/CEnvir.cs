...
namespace Client.Envir
{
    ...
    public static class CEnvir
    {
        ...
        /// 连接客户端
        /// </summary>
        //public static TcpClient ConnectingClient { get; set; }
        /// <summary>
        /// 连接时间
        /// </summary>
        ...
        //    get
        //    {
        //        if (NetworkConfig.UseCloudShield) return NetworkConfig.ShieldIP;
        //        return NetworkConfig.UseNetworkConfig ? NetworkConfig.IPAddress : Config.DefaultIPAddress;
        //    }
        //}
        /// <summary>
        /// 服务器端口
        /// </summary>
        //public static int ServerPort => NetworkConfig.UseNetworkConfig ? NetworkConfig.Port : Config.DefaultPort;
        ...
        /// 重新连接客户端
        /// </summary>
        //public static void ReconnectTcpClient()
        //{
        //    try
        //    {
        //        if (NetworkConfig.UseCloudShield)
        //        {
        //            if (string.IsNullOrEmpty(NetworkConfig.ShieldIP) || string.IsNullOrEmpty(NetworkConfig.ShieldKey))
        //            {
        ...
        //            //连接云盾
        //            int shieldStatus = clinkStart(NetworkConfig.ShieldKey);
        //            if (shieldStatus == 150)
        //            {
        ...
        {
            string path = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "My Games", "Mir3");
        ...
        public static void GameLoop()
        {
            ...
            FrameTime = (FrameTimeTicksAfter - FrameTimeTicksBefore) / 10000;
        }
        /// <summary>
        /// 更新游戏
        /// </summary>
        private static void UpdateGame()
        {
            ...
            if (Connection != null && Connection.ServerConnected && ShouldSendProcessHash)
            {
        ...
        public static void ReturnToLogin()
        {
            ...
            DXControl.ActiveScene = new LoginScene(Config.IntroSceneSize); //控制活动场景 = 新的登录场景大小 （登录界面）
        ...
        public static Task LoadDatabase()
        {
            ...
            Session = new Session(SessionMode.Client, assemblies, DBEncrypted, DBPassword, @".\Data\") { BackUp = false };
            Session.Init();
            //国际化
