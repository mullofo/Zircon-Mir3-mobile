...
namespace Client.Controls
{
    ...
    public sealed class DXConfigWindow : DXWindow
    {
        ...
        public override void OnVisibleChanged(bool oValue, bool nValue)
        {
            ...
            //网络设置
            UseNetworkConfigCheckBox.Checked = NetworkConfig.UseNetworkConfig;        //使用网络配置
            IPAddressTextBox.TextBox.Text = NetworkConfig.IPAddress;                  //IP地址
            PortBox.ValueTextBox.TextBox.Text = NetworkConfig.Port.ToString();        //端口
            //游戏设置    
        ...
        public DXConfigWindow()
        {
            ...
            BGMButton.MouseClick += (o, e) =>
            {
                if (!GameScene.Game.Observer)
                {
                    ...
                    Config.BGM = (BGMButton.Index == 1292);
            ...
            MusicButton.MouseClick += (o, e) =>
            {
                if (!GameScene.Game.Observer)
                {
                    ...
                    Config.OtherMusic = (MusicButton.Index == 1292);
                    DXSoundManager.AdjustVolume();
                }
            };
        ...
        #region Methods
        private void ConfigGround_MouseDown(object sender, System.Windows.Forms.MouseEventArgs e)
        {
            OnMouseDown(e);
        }

        private void BGMPositionBar_OnMoving(object sender, System.Windows.Forms.MouseEventArgs e)
        {
        ...
        private void MusicPositionBar_OnMoving(object sender, System.Windows.Forms.MouseEventArgs e)
        {
        ...
        private void SaveSettings(object o, MouseEventArgs e)
        {
            ...
            NetworkConfig.UseNetworkConfig = UseNetworkConfigCheckBox.Checked;
            NetworkConfig.IPAddress = IPAddressTextBox.TextBox.Text;
            NetworkConfig.Port = (int)PortBox.Value;
