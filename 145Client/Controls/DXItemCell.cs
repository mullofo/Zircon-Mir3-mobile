...
namespace Client.Controls
{
    ...
    public sealed class DXItemCell : DXControl
    {
        ...
        /// 绘制控件
        /// </summary>
        protected override void DrawControl()  //画背包中的物品
        {
            //道具被鼠标选中，不画图片
            ...
            if (DrawItemType == DrawItemType.All || DrawItemType == DrawItemType.OnlyImage)
            {
                ...
                if (Library != null && Item != null)
                {
                    ...
                    if (effectImage != null)
                    {
                        ...
                        {
                            //自定义特效偏移量
                            effectOffset = new Point((Size.Width - effectImage.Width) / 2, (Size.Height - effectImage.Height) / 2);
                        }
                        area.Offset(effectImage.OffSetX + effectOffset.X + imageOffset.X, effectImage.OffSetY + effectOffset.Y + imageOffset.Y);

                        PresentTexture(effectImage.Image, this, area, Color.White, this, 0, 0, (effectImage.ImageTextureType == 1 || effectImage.ImageTextureType == 3 || effectImage.ImageTextureType == 5));
                    }
                    ...
                    if (Item != null && (Item.Flags & UserItemFlags.Marriage) == UserItemFlags.Marriage && image != null)
                    {
                        ...
                        PresentTexture(image.Image, this, DisplayArea, Item.Count > 0 ? Color.White : Color.Gray, this, 0, 0, blend: true);
                    }
                }
            }
        ...
        public void RefreshItem()
        {
            ...
            //道具等级大于1  道具不是武器
            if (Item?.Level > 1 && Item?.Info.ItemType != ItemType.Weapon && ClientDetails.ItemLevelLabel)
            {
