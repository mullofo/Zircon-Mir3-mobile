        ...
        public ItemObject(S.ObjectItem info)
        {
            ...
            switch (itemInfo.Rarity)   //道具极品类型
            {
                ...
                case Rarity.Common:
                    ...
                    {
                        NameColour = ClientDetails.ItemNameGroundCommonColour;
                    ...
                    else
                    {
                        switch (itemInfo.ItemType)
                        {
                            ...
                            case ItemType.Shield:
                                NameColour = ClientDetails.ItemNameGroundEquipColour;
                                break;
                            case ItemType.Nothing:
                            case ItemType.Book:
                            case ItemType.Material:
                                NameColour = ClientDetails.ItemNameGroundNothingColour;
                                break;
                            case ItemType.Consumable:
                                NameColour = ClientDetails.ItemNameGroundConsumableColour;
                                break;
                            default:
                                NameColour = ClientDetails.ItemNameGroundColour;
                                break;
                        }
                ...
                case Rarity.Superior:
                    NameColour = ClientDetails.ItemNameGroundSuperiorColour;
                    ...
                    break;
                case Rarity.Elite:
                    NameColour = ClientDetails.ItemNameGroundEliteColour;
                    if (BigPatchConfig.ChkItemObjShining && !BigPatchConfig.ChkItemObjBeam)
                    {
                        Effects.Add(new MirEffect(40, 8, TimeSpan.FromMilliseconds(100), LibraryFile.ProgUse, 60, 60, Color.MediumPurple)
                        {
