...
namespace Client.Models
{
    ...
    public class PlayerObject : MapObject
    {
        ...
        public override void DrawBlend()
        {
            ...
            DXManager.SetBlend(true, 0.6F, BlendType.HIGHLIGHT);
            DrawBody(false);
        ...
        public void DrawAfterBody(int nOrder)
        {
            ...
            DXManager.Sprite.Draw(DXManager.ScratchTexture, Rectangle.FromLTRB(l, t, r, b), Vector3.Zero, new Vector3(l, t, 0), ShowColor);
            CEnvir.DPSCounter++;
        ...
        public override void DrawHealth()
        {
            ...
            if (data.MaxHealth > 0)
            {
                ...
                library.Draw(80, DrawX, DrawY - cy, Color.White, false, 1F, ImageType.Image);
                library.Draw(79, DrawX + 1, DrawY - cy + 1, color, new Rectangle(0, 0, (int)(size.Width * percent), size.Height), 1F, ImageType.Image);
            }
            ...
            if (data.MaxMana > 0)
            {
                ...
                library.Draw(80, DrawX, DrawY - 58, Color.White, false, 1F, ImageType.Image);
                library.Draw(79, DrawX + 1, DrawY - 58 + 1, color, new Rectangle(0, 0, (int)(size.Width * percent), size.Height), 1F, ImageType.Image);
            }
        }
        /// <summary>
        /// 绘制翅膀
